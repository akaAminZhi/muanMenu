...
function Window({ children, name }) {
  ...
  return createPortal(
    <div className="fixed top-0 left-0 w-full h-screen  backdrop-blur-sm transition duration-300 z-[1000]">
      <div className="fixed min-w-96 border-2 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-yellow-100  rounded-lg shadow-xl transition duration-500 px-4 py-2">
